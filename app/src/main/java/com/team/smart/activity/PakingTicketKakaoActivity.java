...
public class PakingTicketKakaoActivity extends Activity {
    ParkingOrderVO orderVO;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paking_ticket_kakao);
        kakaoActivity = this;
        //인텐트 값 받음
        Intent intent =  getIntent();
        orderVO=(ParkingOrderVO)intent.getSerializableExtra("orderVO");
    ...
    protected void callApi() {
        ...
        //통신
        Call<HashMap> call = apiInterface.ParkingBuyTicket(orderVO);
        call.enqueue(new Callback<HashMap>() {
            ...
            public void onResponse(Call<HashMap> call, Response<HashMap> response) {
                ...
                if(response.code()==200) {
                    ...
                    String p_ocode = resource.get("p_ocode").toString();
                    String tid = resource.get("tid").toString();

                    //응답으로 받은 다음 진행 정보를 웹뷰로 띄워주기
                    webview = (WebView)findViewById(R.id.webView);
                    webview.setWebViewClient(new KakaoWebViewClient(kakaoActivity, "parking",  p_ocode));
